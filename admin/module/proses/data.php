...
?>
        <table id="example2" class="table table-bordered table-hover">
          ...
          <tbody>
            <?php
              ...
              $query = "SELECT *, o.status as stats FROM tbl_order_masuk o, tbl_member m, provinces p WHERE m.id_member=o.id_member AND p.id=m.id_prov AND o.status='T' ORDER BY id_order_masuk LIMIT $limit_start, $limit";
            ...
            ?>
              <tr>
                ...
                <td style="width: 90px"><a href="module/proses/confirm.php?id=<?php echo $row['id_order_masuk']; ?>" id="act" onClick="return confirm('Anda yakin ingin mengkonfirmasi pesanan ini?')" class="btn btn-success">Kirim</button></a></td>
                <!-- </form> -->
                <td>
                <div class="btn-group">
        ...
        <?php
          $query_jumlah = "SELECT count(*) AS jumlah FROM tbl_order_masuk WHERE status='T'";
