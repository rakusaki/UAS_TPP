...
?>
        <table id="example2" class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th>Tanggal Order</th>
              <!-- <th>Alamat</th> -->
              <th style="width: 110px">Konfirmasi Pesanan</th>
              <th>Aksi</th>
            </tr>  
          </thead>
          <tbody>
            <?php
              ...
              $query = "SELECT *, o.status as stats FROM tbl_order_masuk o, tbl_member m WHERE m.id_member=o.id_member AND o.status='P' ORDER BY id_order_masuk LIMIT $limit_start, $limit";
            ...
            ?>
              <tr>
                ...
                <td style="width: 90px"><a href="module/pesanan/confirm.php?id=<?php echo $row['id_order_masuk']; ?>" id="act" onClick="return confirm('Anda yakin ingin mengkonfirmasi pesanan ini?')" class="btn btn-success">Confirm</button></a></td>
                <!-- </form> -->
                <td>
                <div class="btn-group">
        ...
        <?php
          $query_jumlah = "SELECT count(*) AS jumlah FROM tbl_order_masuk WHERE status='P'";
