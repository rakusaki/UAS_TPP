...
<script>
   $(document).ready(function(){
        ...
        function load_data(page){
             $.ajax({
                  url:"../admin/module/pesanan/data.php",
                  method:"POST",
                  data:{page:page},
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-footer">
                    <div class="row">
                        <form action="module/pesanan/cetak.php" method="POST">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9">
                                <lebel></lebel><br>
                                <button type="submit" class="btn btn-info" name="submit">Cetak Laporan Pesanan</button>
                            </div>
                        </form>
                    </div>
                </div>
