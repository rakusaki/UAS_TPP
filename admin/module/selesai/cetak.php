...
<body>
    ...
    <div class="container">
        <div>
            <a class="btn btn-primary" style="margin-top:20px;" href="../../adminweb.php?module=selesai">Kembali</a>
        ...
        <div id="cetak">
            ...
            <table class="table table-bordered" cellpadding="7" border="1">
                ...
                <tbody>
                    <?php
                    $querys = mysqli_query($con, "SELECT * FROM tbl_order_masuk WHERE status = 'S' AND (tgl_order BETWEEN '$set_tgl_awal' AND '$set_tgl_akhir') ");
