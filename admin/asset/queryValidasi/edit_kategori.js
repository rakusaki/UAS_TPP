...
var dataform = $("#edit_kategori").serialize();
    $.ajax({
        url: "module/kategori/aksi_edit.php",
        type: "post",
        data: dataform,
        ...
        var hasil = JSON.parse(result);
            if (hasil.hasil !== "sukses") {
                ...
                $("#pesan").html("<script> alert(\'Data Berhasil Disimpan\'); window.location = \'adminweb.php?module=kategori\';");
